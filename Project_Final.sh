...
echo "5 - Excelente"
read -r pergunta_b
echo "C. Como avalias o teu serviço?" 
echo "1 - Nunca tive"
...
read -r pergunta_c
echo "D. Como avalias a tua resposta ao serviço?" 
...
read -r pergunta_d
echo "E. Como avalias o teu volley?" 
...
read -r pergunta_e
echo "F. Como avalias os teus ressaltos?" 
...
read -r pergunta_g
echo "H. Como avalias a tua pancada de esquerda?"
...
read -r pergunta_h
echo "I. Como avalias a tua pancada de direita?"
...
read -r pergunta_i
total=$(( pergunta_a + pergunta_b + pergunta_c + pergunta_d + pergunta_e + pergunta_f + pergunta_g + pergunta_h + pergunta_i))
echo "$total"
if [[ $total -lt 10 ]]; then
     echo "M5"
